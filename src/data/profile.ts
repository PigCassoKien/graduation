...
export const profile: ProfileData = {
  studentName: 'Dương Minh Kiên',
  schoolName: 'Trường Đại học Công nghệ - Đại học Quốc gia Hà Nội',
  facultyName: 'Khoa Điện tử Viễn thông',
  className: 'K67E-CE1',
  majorName: 'Kỹ thuật Máy tính',
  academicYear: 'QH-2022-I/CQ',
  eventTitle: ' Lễ Tốt Nghiệp',
  degreeTitle: 'Kỹ sư ngành Kỹ thuật máy tính',
  eventDate: '05/07/2026',
  eventTime: '08:00 AM - 10:00 AM',
  eventVenue: 'Hội trường Nguyễn Văn Đạo, 144 Xuân Thủy, Cầu Giấy, Hà Nội',
  eventMapUrl:
